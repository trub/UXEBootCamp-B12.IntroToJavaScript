# UXE - Intro to JavaScript

JavaScript is a core common dynamically typed development language. Understanding the core foundations of this language will be the cornerstone of your learning this language. 
